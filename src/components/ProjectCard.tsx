    ...
    return (
        <div className="bg-zinc-900 bg-opacity-90 rounded-lg shadow-md p-6 border border-gray-500 space-y-6 flex flex-col justify-between h-full">
            <div className="space-y-6">
                ...
                <p className="text-sm md:text-lg"><strong>Technologies: </strong>{technologies}</p>
            </div>
            <div className="flex justify-end items-end mt-auto">
                <Link href={`my-projects/${id}`} className="border border-blue-600 bg-gray-800 hover:bg-gray-700 p-2 rounded-md text-base md:text-sm">MORE...</Link>
            </div>
        </div>
    );
}